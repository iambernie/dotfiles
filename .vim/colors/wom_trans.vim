...
" syntax highlighting
call <SID>X("Number",		"ff5050",	"",			"none")
call <SID>X("Constant",		"e5786d",	"",			"none")
call <SID>X("String",		"ef8a30",	"",			"italic")
call <SID>X("Comment",		"f6c709",	"",			"italic")
call <SID>X("Identifier",	"caeb82",	"",			"none")
call <SID>X("Keyword",		"87afff",	"",			"none")
call <SID>X("Statement",	"3075a6",	"",			"none")
call <SID>X("Function",		"cf5ed0",	"",			"none")
